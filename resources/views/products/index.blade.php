        ...
        <div class="flex gap-10">
            ...
            <div class="flex flex-col w-full md:w-4/5">
                ...
                <div class="flex justify-between items-center text-gray-500 border-b border-gray-200 mb-10">
                    <h2 class="text-sm  text-gray-600">Showing <span id="product-count-display" class="text-black">
                        0-0 of 0
                    </h2>
                    <div class="inline-flex items-center space-x-2">
                        <div class="text-sm text-gray-600">Sort by:</div>
                        <select
                            class="form-select block mt-1 px-2 text-sm rounded-md border-gray-300  focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
...
@section('scripts')
    ...
    <img src="${product.thumb}" alt="${product.name}" class="product-image h-48 w-full object-contain">
    <div class="p-5">
        <h3 class="text-md font-mono text-gray-800 mb-2">${product.name.length > 25 ? product.name.slice(0, 25) + '...' : product.name}</h3>
        ...
        <div class="flex gap-2 flex-col lg:flex-row">
            ...
            <button onclick="window.addToCart(${product.id}, '${product.name}', ${product.price}, '${product.thumb}')" class="
        ...
        const target = document.getElementById('load-product-point');
        ...
        async function loadMoreProducts() {
            ...
            try {
                ...
                `/api/products-paginated?offset=${currentOffset}&limit=${productsPerPage}`);
