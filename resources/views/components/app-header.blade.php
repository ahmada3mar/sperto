...
<header class="bg-white main shadow-sm p-4 fixed w-full z-50 top-0">
    <div class="container mx-auto flex md:flex-row-reverse flex-row justify-between items-center">
        <div class="flex gap-10">
            {{-- User Icon (Desktop) --}}
            <nav class="hidden md:flex items-center space-x-4">
                <button class="relative text-gray-600 hover:text-gray-900 transition-all-ease focus:outline-none">
            ...
            <nav class="hidden md:flex items-center space-x-4">
                ...
                <button class="relative text-gray-600 hover:text-gray-900 transition-all-ease focus:outline-none" data-open-cart-aside>
        ...
        <div class="md:hidden block mr-auto">
            ...
            <label id="nav-icon" for="menu-toggle" class="z-50">
                <i class="transition-all fa-solid fa-bars text-2xl"></i>
            </label>
        </div>
